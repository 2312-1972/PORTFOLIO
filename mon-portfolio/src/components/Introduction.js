...
const Introduction = () => {
  ...
  <div className=' back-intro ' >
   ...
   <OrbAnimation/>
   <div>
    <p className='letter-space intro-contact p1' style={{marginTop:'200px'}}>
Je m'appelle <span className='h-intro' style={{border:'none', fontWeight:'bold',fontSize:'22px'}}> Frédéric TOPPAN, </span>enthousiaste du code et passionné par le monde numérique, je suis un développeur web dédié à créer des expériences en ligne exceptionnelles. 
Avec une solide formation et une expérience pratique, je suis constamment à la recherche de nouvelles façons d'innover et d'améliorer la façon 
dont les utilisateurs interagissent avec le web. 
</p>
<p className='letter-space intro-contact p2'>
Ma boîte à outils comprend une expertise approfondie dans les langages de programmation tels que HTML, CSS, JavaScript, 
ainsi que des frameworks modernes tels que React.js et Node.js. J'ai développé et déployé avec succès une variété de sites web réactifs, 
du simple site vitrine aux applications web complexes.
</p>
<p className='letter-space intro-contact p3'>
Mon approche du développement web se caractérise par une attention méticuleuse aux détails, 
un engagement envers la qualité du code et un désir constant d'apprendre et de m'adapter aux dernières tendances de l'industrie. 
Je suis convaincu que la collaboration étroite avec les clients est essentielle pour comprendre leurs besoins uniques et créer 
...
Si vous recherchez un développeur web passionné par son métier et engagé à offrir des solutions de qualité, 
je serais ravi de discuter de la façon dont nous pouvons collaborer pour atteindre vos objectifs numériques.
        </p>
        </div>
